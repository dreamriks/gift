...
if ($ver_files != $ver_inst)
{
	...
	if ($task != "update" || $view != "backup")
		JError::raiseWarning( 100, JText::sprintf('INCORRECT_VERSION',JRoute::_('index.php?option=com_fst&view=backup&task=update')) );
...
$css = JRoute::_( "../index.php?option=com_fst&view=css" );
...
//	JFactory::getApplication()->set('jquery', true);
	$document->addScript( JURI::root().'/components/com_fst/assets/js/jquery.1.6.2.min.js' );
//}
