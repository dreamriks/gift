...
class FstsModelProds extends JModel
{
    ...
    function _buildQuery()
    {
        ...
        $query = ' SELECT c.id, c.title, c.ordering as ordering, c.published, c.description, c.image, c.inkb, c.insupport, c.intest FROM #__fst_prod as c ';
