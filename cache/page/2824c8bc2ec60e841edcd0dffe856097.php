...
<head>
  ...
  <base href="http://giftjaipur.com/component/virtuemart/user/editaddresscartBT" />
  ...
  <link rel="stylesheet" href="http://giftjaipur.com/components/com_virtuemart/assets/css/vmpanels.css" type="text/css" />
...
faceboxHtml = '<div id="facebox" style="display:none;"><div class="popup"><div class="content"></div> <a href="#" class="close"></a></div></div>'  ;
	...
	$$("a.modal").each(function(el) {
		...
		jQuery('#VMmenu892009_3 li.VmClose ul').hide();
		jQuery('#VMmenu892009_3 li .VmArrowdown').click(
		function() {

			if (jQuery(this).parent().next('ul').is(':hidden')) {
				jQuery('#VMmenu892009_3 ul:visible').delay(500).slideUp(500,'linear').parents('li').addClass('VmClose').removeClass('VmOpen');
...
<form action="http://giftjaipur.com/component/virtuemart/user/editaddresscartBT" method="post">
	<div align="right">
...
<div class="vmCartModule " id="vmCartModule">
	...
	<div class="vm_cart_products">
		<div class="container">
						  <div class="prices" style="float: right;">640,00 ₨</div>
							<div class="product_row">
				<span class="quantity">1</span>&nbsp;x&nbsp;<span class="product_name"><a href="/Products/Combo-Product-Jaipur/12-Red-Rose-Motichoor-Ladoo-detail" >12 Red Rose + Motichoor Ladoo</a></span>
			</div>
					</div>
	</div>

<div class="total" style="float: right;">
	Total : <strong>640,00 ₨</strong></div>
<div class="total_products">1 product</div>
<div class="show_cart">
	<a style ="float:right;" href="/component/virtuemart/cart">Show Cart</a></div>
...
<ul class="VMmenu" ID="VMmenu892009_3"  >
...
<li class="VmClose"> 
  ...
  <!--  <form action="" method="post" name="com-login" >
		<div>
		<h2></h2>
	</div>
<div class="clear"></div>
        ...
        <p class="width30 floatleft" id="com-form-login-username">
            <input type="text" name="username" class="inputbox" size="18" alt="" value="" onblur="if(this.value=='') this.value='';" onfocus="if(this.value=='') this.value='';" />
	</p>

        <p class="width30 floatleft" id="com-form-login-password">
                        <input type="password" id="passwd" name="passwd" class="inputbox" size="18" alt="" value="" onblur="if(this.value=='') this.value='';" onfocus="if(this.value=='') this.value='';" />
                        <input id="modlgn-passwd" type="password" name="password" class="inputbox" size="18" alt="" value="" onblur="if(this.value=='') this.value='';" onfocus="if(this.value=='') this.value='';" />
            	</p>

        <p class="width30 floatleft" id="com-form-login-remember">
            <input type="submit" name="Submit" class="default" value="" />
        ...
        <input type="hidden" name="return" value="L2NvbXBvbmVudC92aXJ0dWVtYXJ0L3VzZXIvZWRpdGFkZHJlc3NjYXJ0QlQ=" />
        <input type="hidden" name="0559d67e31651ab0baa2c6af63547dfe" value="1" />    </form>
...
<fieldset>
    <h2>Add/Edit sender information    </h2>

    <form method="post" id="userForm" name="userForm" class="form-validate">
    <!--<form method="post" id="userForm" name="userForm" action="/component/virtuemart/" class="form-validate">-->
	<div class="control-buttons">
	    Please use <strong>Save sender information</strong> to save sender information
    	   <!-- <button class="" type="submit" onclick="javascript:return callValidatorForRegister(userForm);" title=""></button> -->
    		    <button class="button vm-button-correct" title="Save sender information" type="submit" onclick="javascript:return myValidator(userForm, 'savecartuser');" >Save sender information</button>
		    	    <button class="default" type="reset" onclick="window.location.href='/component/virtuemart/cart'" >Cancel</button>


	</div>


	    <span class="userfields_info">Fill in those fields to create an account</span>	<table  class="adminForm user-details">
		<tr>
			<td class="key" title="" >
...
<span class="userfields_info">Add/Edit sender information</span>	<table  class="adminForm user-details">
		<tr>
			<td class="key" title="" >
			...
			<td>
				<input type="text" id="company_field" name="company" size="30" value=""  maxlength="64" /> 
			</td>
		</tr>
		<tr>
			<td class="key" title="" >
		...
		<tr>
			...
			<td>
				<input type="text" id="middle_name_field" name="middle_name" size="30" value=""  maxlength="32" /> 
			</td>
		</tr>
		<tr>
			<td class="key" title="" >
		...
		<tr>
			...
			<td>
				<input type="text" id="address_2_field" name="address_2" size="30" value=""  maxlength="64" /> 
			</td>
		</tr>
		<tr>
			<td class="key" title="" >
		...
		<tr>
			...
			<td>
				<input type="text" id="phone_2_field" name="phone_2" size="30" value=""  maxlength="32" /> 
			</td>
		</tr>
		<tr>
			<td class="key" title="" >
...
<div id="comments" class="fst_comments_result">
			<div class='fst_comment' id='fst_comment_6'  ><div class='fst_comment_name'>Ankur Gupta</div>
	<div class='fst_comment_commentmod'>Thank you from the core of my heart for sending the superb flower bouquet to my younger brother.</div></div><div class='fst_clear'></div>			<div class='fst_comment' id='fst_comment_2'  ><div class='fst_comment_name'>Puneet Dudi</div>
	<div class='fst_comment_commentmod'>Thanks a lot. I am mesmerized with the punctual delivery of your gifts and flowers to my Sweetheart in Jaipur.</div></div><div class='fst_clear'></div>	</div>
...
function fst_remove_comment(commentid) {
    ...
    var url = "/component/virtuemart/user/removecomment?limit=int&commentid=XXCIDXX";
...
function fst_approve_comment(commentid) {
    ...
    var url = "/component/virtuemart/user/approvecomment?limit=int&commentid=XXCIDXX";
    url = url.replace("XXCIDXX",commentid);
    jQuery.get(url);
}
function fst_delete_comment(commentid) {
    ...
    var url = "/component/virtuemart/user/deletecomment?limit=int&commentid=XXCIDXX";
    url = url.replace("XXCIDXX",commentid);
    jQuery.get(url);
}
function fst_edit_comment(commentid) {
    jQuery('#fst_comment_' + commentid).html('PLEASE_WAIT');
    var url = "/component/virtuemart/user/editcomment?limit=int&commentid=XXCIDXX";
    url = url.replace("XXCIDXX",commentid);
...
{
    var url = "/component/virtuemart/user/showcomment?limit=int&commentid=XXCIDXX";
    url = url.replace('XXCIDXX', commentid);
...
function fst_moderate_refresh() {
    ...
    var url = "/component/virtuemart/user/modinner?limit=int&ident=XXXIDXX&published=XXPXX";
