...
class FST_Captcha
{
	function GetCaptcha()
	{
		...
		if ($usecaptcha == "")
			return "";
		if ($usecaptcha == "fsj")
			return "<img src='" . JRoute::_("index.php?option=com_fst&task=captcha_image&random=" . rand(0,65535)) . "' /><input id='security_code' name='security_code' type='text' style='position: relative; top: -14px; left: 3px;'/>";
