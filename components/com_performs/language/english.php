...
define('EMAIL_ADMIN',"<code>To List</code> is <em>admin</em>:");
define('EMAIL_ADMIN_INFO', "If yes, perForms will send a copy of the email to the address(es) in the \&apos;to\&apos; field - if the field is blank and \&apos;Email Form\&apos; is \&apos;yes\&apos;, an email is sent to the site administrator. Included with <strong>admin</strong> emails are: a link to view the submission back at the joomla (manager and above), and xml file attachment (if allowed).");
...
define('VALUE_INFO',"For <em>Text Items</em>, sets the default value. Enter a value in this field and click the ".INSERT." button to add to the list.<br /><br /> For <strong>".ITEMTYPE_FILE."</strong> items, enter the default upload path here, with a trailing separator <br />(eg <code>/path/to/uploads/</code> or <code>c:\\\uploads\\\</code>).");
...
define('ATTACH_XML_FORM', "Attach Xml Form - Admin");
define('ATTACH_XML_FORM_INFO', "If yes, perForms will attach an xml file representing the submitted form to any emails sent, to the 'admin' group ('To' List).");
define('ATTACH_XML_FORM_USER', "Attach Xml Form - User");
define('ATTACH_XML_FORM_USER_INFO', "If yes, perForms will attach an xml file representing the submitted form to any emails sent.");
