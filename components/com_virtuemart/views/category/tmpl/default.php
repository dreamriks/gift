...
?>
			...
			<!--	<span style="float:left">	--><?php echo $this->vmPagination->getPagesCounter(); ?><br />
				 <?php echo $this->vmPagination->getPagesLinks(); ?>	<!--  </span>-->
				</div>
...
?>
<!-- /div removed valerie -->
	<div class="vm-pagination" align="center"><?php echo $this->vmPagination->getPagesLinks(); ?><br /><!-- <span style="float:right">--><?php echo $this->vmPagination->getPagesCounter(); ?><!-- </span>--></div>
<!-- /div removed valerie -->
