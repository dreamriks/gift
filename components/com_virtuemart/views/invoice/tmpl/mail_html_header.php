...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="html-email">
	<tr>
    <td align="top" width="70%"><div align="center"><strong><h1>Invoice</h1></strong></div></td>
		<td width="30%" align="right">
			<img src="http://giftjaipur.com/test/images/stories/virtuemart/vendor/GiftJaipur_bcf_small.jpg"<?php // echo JURI::root () . $this->vendor->images[0]->file_url. GiftJaipur_bcf_small.jpg ?> />
		</td>
		<td>
