...
if ($cc_payments==true) { 
	...
	<fieldset><legend><strong><?php echo $VM_LANG->_('PHPSHOP_CHECKOUT_PAYMENT_CC') ?></strong></legend>
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
		    <tr>
		        <td colspan="2">
		        	<?php ps_paypal_api::list_cc($payment_method_id, false) ?>
		        </td>
		    </tr>
		    <tr>
   ...
   ?>
    <fieldset><legend><strong><?php echo $title ?></strong></legend>
		<table border="0" cellspacing="0" cellpadding="2" width="100%">
		    <tr>
		        <td colspan="2"><?php 
		            ps_paypal_api::list_nocheck($payment_method_id,  false); 
		            ps_paypal_api::list_bank($payment_method_id,  false);
		            ps_paypal_api::list_paypalrelated($payment_method_id,  false); ?>
		        </td>
		    </tr>
		 </table>
	</fieldset>
