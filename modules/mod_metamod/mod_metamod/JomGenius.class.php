 ...
 * v11 Core: added detection for another method articlenew pagetype; VM: added virtuemart history queries
 * v12 VM: improved detection of pagetype when using One Step Checkout. Also now return value of page URL parameter for pagetype, if nothing else matches.
 */
