...
* Modified By : Max Guglielmino (mxgs@libero.it)
...
//$textlength=$params->get('text_length',20);
define('textlength', $params->get('text_length',20));
...
//                 $html   = "\n<select class=\"inputbox\" name=\"$tag_name\" $tag_attribs>";
                 $html   = "<br /><select class=\"inputbox\" name=\"$tag_name\" $tag_attribs>";
                 $count  = count( $arr );
                 ...
                 for ($i=0, $n=$count; $i < $n; $i++ ) {
                         ...
                         //Start of change by Max mxgs@libero.it
                         if (strlen($t) > textlength) {
							$t = truncstring($t, textlength);
							$t = $t."...";
                        			}
						if ($i == 0) {
							$t = JText::_('Select Product');
						}
			//End of change by Max mxgs@libero.it
