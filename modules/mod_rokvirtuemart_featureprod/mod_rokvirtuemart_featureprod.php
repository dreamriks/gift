...
*
* @version $Id: mod_rokvirtuemart_featureprod.php 1159 2008-01-14 20:30:30Z soeren_nb $
* @package VirtueMart
* @subpackage modules
*
	...
	while($db->next_record() ){
        ...
        ?>
			<tr align="center" class="<?php echo $sectioncolor ?>">
				<td width="<?php echo $width ?>%" class="imageThumb">
					<?php 
		...
		elseif( $display_style== "horizontal" ) {
			if( $i == 0 )
			echo "<tr>\n";
			echo "<td width=\"$width%\" align=\"center\" class=\"imageThumb\">";
			$ps_product->show_snapshot($db->f("product_sku"), $show_price, $show_addtocart);
			echo "</td>\n";
			if( ($i+1) == $db->num_rows() )
			echo "</tr>\n";
