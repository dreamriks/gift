<?php
/* The simple email module is configured to use Joomla mail.  If you still have problems try these steps:
 * 	1.	Review your Joomla email configuration and make sure it's set up properly
 *  2.	Check to see if your server is configured to send mail
 *  3.	Copy this program to your document root and use it to test to see if your server can send PHP email.
 */
$message = "";
