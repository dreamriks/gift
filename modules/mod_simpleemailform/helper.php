...
/*
		...
		2012-05-11 DB:
		* Added dump of params if in test mode
		* Fixed problem where multiple instances of form renders same name and id tags for form element
		* 	name and id tags now add "_<instance>".  I.e. <input type="text" name="field1_1" ... />
		* TO DO: Add feature where you can specify the name which appears in the "From" field if reply-to is active
		* From: 	"Alberts Muktupāvels: I have found two "bugs" in your joomla module.  In helper.php file:
		* 1. Line 653 should be [$this->_badEmail .= $this->_transLang['MOD_SIMPLEEMAILFORM_email_invalid'];] not [$this->_badEmail .= $this->formatErrorMessage($this->_errorTxtColor, $this->_transLang['MOD_SIMPLEEMAILFORM_email_invalid']);] . Error message is formated later in line 674 by formatRow function.
		* 2. Line 697 should be [. $this->_inputClass . ' '] not [. $this->_inputClass] . 
		* Currently it generate class and name attributes without space between them.
*/
