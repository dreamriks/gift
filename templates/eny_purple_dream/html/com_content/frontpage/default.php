...
<div class="blog<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		...
		<div class="eny_first_article<?php echo $this->params->get('pageclass_sfx'); ?>">
		...
		<div class="article_row<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
			...
			<div class="eny column<?php echo $z + 1; ?> cols<?php echo $colcount; ?>" >
			<?php $this->item =& $this->getItem($i, $this->params);
			echo $this->loadTemplate('item'); ?>
			</div>	
			<?php endfor; ?>
		...
		<div class="eny_blog_more<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
		...
		<?php endif; ?>
			...
			<p style="text-align:center;padding-top:8px;margin-top:25px;">
