 ...
 * @version 	$Id: com_virtuemart.php 1891 2012-02-11 10:43:52Z RolandD $
 */
...
class Com_VirtueMart {
	...
	*/
	 ...
	 * @since 		3.0
	 */
	public function createCategoryPath($product_id) {
		$db = JFactory::getDbo();
		...
		// Return the paths
		return implode('|', $this->constructCategoryPath($catids));
	}
	 ...
	 * @since 		4.0
	 */
	public function createCategoryPathById($catid) {
		if (!is_array($catid)) $catids = array($catid);
		return implode('|', $this->constructCategoryPath($catids));
	}
