 ...
 * @version 	$Id: categoryimport.php 1891 2012-02-11 10:43:52Z RolandD $
 */
...
class CsviModelCategoryimport extends CsviModelImportfile {
	...
	private function _loadTables() {
		...
		if (!in_array($db->getPrefix().'virtuemart_categories_'.$template->get('language', 'general'), $tables)) {
	...
	public function getProcessRecord() {
		...
		if (!isset($this->virtuemart_category_id)) {
			$categoryid = $this->_categoriesmodel->getCategoryIdFromPath($this->category_path);
