 ...
 * @version 	$Id: categories_lang.php 1891 2012-02-11 10:43:52Z RolandD $
 */
...
class TableCategories_lang extends JTable {
	...
	public function __construct($db) {
		...
		parent::__construct('#__virtuemart_categories_'.$template->get('language', 'general'), 'virtuemart_category_id', $db);
	}
